...
- Name: bookmarklet.spec.ts >> Webbender E2E Tests >> should switch to install tab
- Location: tests/e2e/bookmarklet.spec.ts:16:7
...
Call log:
  - waiting for locator('[data-tab="install"]')
