...
- Name: bookmarklet.spec.ts >> Webbender E2E Tests >> should display description tab by default
- Location: tests/e2e/bookmarklet.spec.ts:10:7
...
Locator: locator('[data-tab="description"]')
Expected: "true"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-tab="description"]')
